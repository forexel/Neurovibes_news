SOURCES = [
    ...
    # Research / links
    ("Hugging Face", "https://huggingface.co/papers/date/{date}", 32, 0.0, "html"),
    ("Papers with Code (latest)", "https://paperswithcode.com/latest/rss", 33, 0.0),
    ("arXiv cs.CL", "https://export.arxiv.org/rss/cs.CL", 34, 0.0),
    ("arXiv cs.LG", "https://export.arxiv.org/rss/cs.LG", 35, 0.0),
    ("arXiv cs.AI", "https://export.arxiv.org/rss/cs.AI", 36, 0.0),
    ("Hacker News (best)", "https://hnrss.org/best", 37, 0.0),
    ("Hacker News (frontpage)", "https://hnrss.org/frontpage", 38, 0.0),
    ("Supabase AI RSS", "https://zdpdvwhvukelzzbzbjvh.supabase.co/functions/v1/rss-feed", 39, 0.0),
