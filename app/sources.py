SOURCES = [
    ...
    ("Hacker News RSS (best)", "https://hnrss.org/best", 41, 0.0),
    ("Hacker News RSS (frontpage)", "https://hnrss.org/frontpage", 42, 0.0),
    ("Hacker News RSS (newest AI)", "https://hnrss.org/newest?q=AI", 43, 0.0),
    ("Hacker News RSS (newest agent)", "https://hnrss.org/newest?q=agent", 44, 0.0),
